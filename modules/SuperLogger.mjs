...
class SuperLogger {
    ...
    // These are arbitrary values to make it possible for us to sort our log messages. 
    static LOGGING_LEVELS = {
        ...
        IMPORTANT: 100, // We output just siginficant messages
    ...
    constructor() {
        // This constructor will always return a refrence to the first instance created. 
